...
const FALLBACK_DIGESTS: HorizonDigest[] = [
  ...
  },
  {
    ...
    articles: [
      ...
      { title: '21 Hospital M&As Finalized in 2026', outlet: "Becker's Hospital Review", url: 'https://www.beckershospitalreview.com/hospital-transactions-and-valuation/21-hospital-mas-finalized-in-2026/', date: '2026-07-10' },
      { title: 'DOJ Continues Scrutiny of Health System Contracting in Second 2026 Antitrust Case', outlet: 'Morgan Lewis', url: 'https://www.morganlewis.com/pubs/2026/03/doj-continues-scrutiny-of-health-system-contracting-in-second-2026-antitrust-case', date: '2026-03-31' },
      { title: "CMS's CY 2026 Updates to Hospital Price Transparency and MRF Requirements", outlet: 'Stroudwater Associates', url: 'https://www.stroudwater.com/cmss-cy-2026-updates-to-hospital-price-transparency-and-machine-readable-file-requirements/', date: '2026-01-20' },
    ],
  },
];
